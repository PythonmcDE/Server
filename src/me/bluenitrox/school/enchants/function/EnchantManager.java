...
public class EnchantManager {
    ...
    public static final String KILL_COUNTER = "§c§lKill-Counter ";
    public static final String Mob_Counter = "§c§lMob-Counter ";
    ...
    public static final String Käfig = "§9§lKäfig ";
    public static final String BowCounter = "§9§lKill-Counter ";
    ...
    public static final String BlockCounter = "§6§lBlock-Counter ";
