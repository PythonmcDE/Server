...
public class GetOptions implements CommandExecutor {
    ...
    public void onInventoryClick(InventoryClickEvent event) {
        ...
        UUID uuid = player.getUniqueId();
        HashMap<Material, Boolean> value = me.bluenitrox.school.mine.minensettings.GetOptions.getMiningSettings().getMinenSettings().get(uuid);
