        ...
        if(p.hasPermission(PermissionsManager.ALLPERMS)){
            if(args.length == 0) {
                ...
                if(args[0].equalsIgnoreCase("zwei")){
                    ...
                    ItemStack is4 = new ItemBuilder(Material.ENCHANTED_BOOK).setDisplayname("§8» §6§lMagisches Buch").setLore(EnchantManager.KILL_COUNTER + "I").build();
                    ItemStack is5 = new ItemBuilder(Material.ENCHANTED_BOOK).setDisplayname("§8» §6§lMagisches Buch").setLore(EnchantManager.BlockCounter + "I").build();
                    ItemStack is6 = new ItemBuilder(Material.ENCHANTED_BOOK).setDisplayname("§8» §6§lMagisches Buch").setLore(EnchantManager.BowCounter + "I").build();
                    ItemStack is7 = new ItemBuilder(Material.ENCHANTED_BOOK).setDisplayname("§8» §6§lMagisches Buch").setLore(EnchantManager.Mob_Counter + "I").build();
