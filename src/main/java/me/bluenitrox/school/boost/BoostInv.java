...
public class BoostInv implements CommandExecutor {
    ...
    public static void setBoostContent(Inventory inv, Player p){
        ...
        ItemStack sign = new ItemBuilder(Material.SIGN).setDisplayname("§6Booster Menu").setLore("§b» §7Booster kannst du auf Unserer Website", "§b» §7PythonMC.de kaufen!").build();
