...
public class KitAPI {
    ...
    private void setKitContent(Inventory inv, Player p){
        ...
        ItemStack ka1 =new ItemBuilder(Material.STONE_SWORD).setDisplayname("§b§o§lStein").setLore("§8» §7Noch §cnicht freigeschaltet§7!", "§8» §7Hole das §6vorherige Kit §7noch §6§l" + getStein(uuid) +" mal §7ab!").build();
        ItemStack ka2 =new ItemBuilder(Material.IRON_SWORD).setDisplayname("§b§o§lEisen").setLore("§8» §7Noch §cnicht freigeschaltet§7!", "§8» §7Hole das §6vorherige Kit §7noch §6§l" + getEisen(uuid) +" mal §7ab!").build();
        ItemStack ka3 =new ItemBuilder(Material.BOW).setDisplayname("§b§o§lWarzone").setLore("§8» §7Noch §cnicht freigeschaltet§7!", "§8» §7Hole das §6vorherige Kit §7noch §6§l" + getWarzone(uuid) + " mal §7ab!").build();
        ItemStack ka4 =new ItemBuilder(Material.DIAMOND_SWORD).setDisplayname("§b§o§lDiamant").setLore("§8» §7Noch §cnicht freigeschaltet§7!", "§8» §7Hole das §6vorherige Kit §7noch §6§l" + getDiamant(uuid) +" mal §7ab!").build();
        ItemStack ka5 = new ItemBuilder(Material.DIAMOND_PICKAXE).setDisplayname("§b§o§lBergarbeiter").setLore("§8» §7Noch §cnicht freigeschaltet§7!", "§8» §7Kaufpreis: §61 Mio Gems").build();
        ItemStack ka6 =new ItemBuilder(Material.GOLD_INGOT).setDisplayname("§b§o§lGoldfinger").setLore("§8» §7Noch §cnicht freigeschaltet§7!", "§8» §7Hole das §6vorherige Kit §7noch §6§l" + getGoldfinger(uuid) +" mal §7ab!").build();
        ItemStack ka7 = new ItemBuilder(Material.DIAMOND).setDisplayname("§b§o§lJuwelier").setLore("§8» §7Noch §cnicht freigeschaltet§7!", "§8» §7Hole das §6vorherige Kit §7noch §6§l" + getJuwelier(uuid) +" mal §7ab!").build();
        ItemStack ka8 = new ItemBuilder(Material.EMERALD).setDisplayname("§b§o§lBänker").setLore("§8» §7Noch §cnicht freigeschaltet§7!", "§8» §7Hole das §6vorherige Kit §7noch §6§l" + getBanker(uuid) +" mal §7ab!").build();
        ItemStack ka9 = new ItemBuilder(Material.MELON).setDisplayname("§b§o§lNinja").setLore("§8» §7Noch §cnicht freigeschaltet§7!", "§8» §7Kaufpreis: §65 Mio Gems").build();
        ItemStack ka10 = new ItemBuilder(Material.SULPHUR).setDisplayname("§b§o§lSensei").setLore("§8» §7Noch §cnicht freigeschaltet§7!", "§8» §7Hole das §6vorherige Kit §7noch §6§l" + getSensei(uuid) + " mal §7ab!").build();
        ItemStack ka11 = new ItemBuilder(Material.GOLD_CHESTPLATE).setDisplayname("§b§o§lMeister").setLore("§8» §7Noch §cnicht freigeschaltet§7!", "§8» §7Hole das §6vorherige Kit §7noch §6§l" + getMeister(uuid) +" mal §7ab!").build();
